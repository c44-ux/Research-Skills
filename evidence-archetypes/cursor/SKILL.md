...
description: >-
  UX research skill (Cursor variant) — create evidence-based behaviour archetypes
  ...
  segments, or when the user says persona/archetype and provides study materials.
disable-model-invocation: true
---

# Evidence Archetypes (Cursor)
