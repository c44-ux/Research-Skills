...
Part of [Research-Skills](https://github.com/c44-ux/Research-Skills). **Claude variant:** [`../claude/`](../claude/).
...
Use folder: `Research-Skills/method-synopsis/cursor/`
...
```text
.cursor/skills/method-synopsis/       # copy contents of method-synopsis/cursor/
.cursor/commands/method-synopsis.md   # copy from method-synopsis/cursor/commands/
